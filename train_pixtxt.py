...
def train(loader,net,opt,criteria,train_size,logger,work_dir,train_detector=False):
    # maxh,maxw = 600,1200
    max_boxes = 3
...
if __name__ == "__main__":
    ...
    for i in range(args.epoch):
        ret = train(dataloader,net,opt,loss,len(train_dataset),logger,img_dir,train_detector=train_detector)
    # except Exception as e:
    #     print(e)
